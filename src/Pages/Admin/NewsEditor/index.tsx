...
function AdminNewsEditorPage() {
    ...
    if (width < 992) {
        return <div className='
                ...
                '
        >
            <p className='mb-4'>Tính năng không hỗ trợ trên mobile</p>
            <span className='max-w-[300px]'>{emptySvg}</span>
        </div>
    }
